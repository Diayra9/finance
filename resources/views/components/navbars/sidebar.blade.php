...
<aside
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="{{ url('/transactions') }}" type="button">View Transaction</a>
        </div>
        @if(auth()->user()->hasRole('admin'))
            <div class="mx-3">
                <a class="btn bg-gradient-primary w-100" href="{{ url('/wallets') }}">View Wallet</a>
            </div>
            <div class="mx-3">
                <a class="btn bg-gradient-primary w-100" href="{{ url('/categories') }}">View Category</a>
            </div>
        @endif
